...
{
	unsigned long ID;
	McCfgTransXYZType Translation;
	McCfgOrientType Orientation;
	McWSCubeDimType Dimension;
} McWSCubeType;

typedef struct McWSCubesType
{
	McCfgUnboundedArrayType Cuboid;
} McWSCubesType;
...
typedef struct McWSHalfSpcType
{
	...
	McCfgTransXYZType Translation;
	McCfgOrientType Orientation;
	McWSHalfSpcPlEnum Plane;
} McWSHalfSpcType;

typedef struct McWSHalfSpcsType
{
	McCfgUnboundedArrayType HalfSpace;
} McWSHalfSpcsType;
...
typedef struct McWSTcConeType
{
	...
	McCfgTransXYZType Translation;
	McCfgOrientType Orientation;
	McWSTcConeParType Parameters;
} McWSTcConeType;

typedef struct McWSTcConesType
{
	McCfgUnboundedArrayType TruncatedCone;
} McWSTcConesType;

typedef struct McWSWorkSpaceType
{
	McWSCubesType Cuboids;
	McWSHalfSpcsType HalfSpaces;
	McWSTcConesType TruncatedCones;
} McWSWorkSpaceType;
...
{
	McWSWorkSpaceType WorkSpace;
	McWSSafeSpaceType SafeSpace;
} McCfgWorkspaceType;
