...
#define _McPathGen_VERSION 5.07.1
#endif
...
{	mcPATHGEN_DYNMODIDENT_IDENTIFY
...
typedef enum McMS5ADADynMdlEnum
{	mcMS5ADADM_DYNPARTABLE = 0
} McMS5ADADynMdlEnum;
...
typedef struct McMSTransXYZType
{	double X;
	double Y;
	double Z;
} McMSTransXYZType;
...
{	struct McMSDeltaDSDEEPArmLinkPtType ArmLinkPoint[3];
	struct McMSTransXYZType TranslationToFlange;
...
typedef struct McMS5ADADynMdlDynParTableType
{	struct McCfgReferenceType TableReference;
} McMS5ADADynMdlDynParTableType;

typedef struct McMS5ADADynMdlType
{	enum McMS5ADADynMdlEnum Type;
	struct McMS5ADADynMdlDynParTableType DynParTable;
} McMS5ADADynMdlType;
...
{	struct McMS5ADADescType Description;
	...
	struct McMS5ADADynMdlType DynamicModel;
...
{	struct McCfgTransXYZType TranslationFromBaseToQ1;
	struct McMSTransXYZType TranslationFromQ1ToQ2;
	struct McCfgTransXYZType TranslationFromQ2ToQ3;
	struct McCfgTransXYZType TranslationFromQ3ToQ4;
...
typedef struct MC_BR_GroupDynModIdent
{
	/* VAR_INPUT (analog) */
	...
	plcbit Error;
} MC_BR_GroupDynModIdent_typ;



/* Prototyping of functions and function blocks */
_BUR_PUBLIC void MC_BR_GroupDynModIdent(struct MC_BR_GroupDynModIdent* inst);
