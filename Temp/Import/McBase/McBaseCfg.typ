TYPE
	...
	McCfgTypeEnum :
		...
		mcCFG_AXGRP_FEAT_DYN_MDL_IDENT := 21123, (*Associated with data type McCfgAxGrpFeatDynMdlIdentType*)
	...
	McCfgOrientType : STRUCT (*Orientation parameters*)
		Angle1 : LREAL; (*Rotation about first coordinate of the rotation order [measurement units]*)
		Angle2 : LREAL; (*Rotation about second coordinate of the rotation order [measurement units]*)
		Angle3 : LREAL; (*Rotation about third coordinate of the rotation order [measurement units]*)
	END_STRUCT;
	...
	McCfgLimJerkBaseType : STRUCT (*Type mcAGFPDPLIJ_BASIC settings*)
		Jerk : REAL; (*Jerk limit in any movement direction [Measurement units/s³]*)
	END_STRUCT;
	McCfgTransXType : STRUCT (*Translation from base of the mechanical system to QX*)
		X : LREAL; (*Translation in X direction [measurement units]*)
	END_STRUCT;
	McCfgTransYType : STRUCT (*Translation from QX to QY*)
		Y : LREAL; (*Translation in Y direction [measurement units]*)
	END_STRUCT;
	McCfgTransZType : STRUCT (*Translation from QY to QZ*)
		Z : LREAL; (*Translation in Z direction [measurement units]*)
	END_STRUCT;
